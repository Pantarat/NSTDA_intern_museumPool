...
CREATE TABLE `object_population` (
  ...
  `Visited_Time` int NOT NULL,
  PRIMARY KEY (`VisitorLog_ID`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `object_population`
--

LOCK TABLES `object_population` WRITE;
/*!40000 ALTER TABLE `object_population` DISABLE KEYS */;
/*!40000 ALTER TABLE `object_population` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-20 10:44:39
