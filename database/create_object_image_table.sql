...
CREATE TABLE `object_image` (
  ...
  `ObjectDescription_Name` varchar(400) DEFAULT NULL,
  `ObjectDescription` longtext,
  `ImageObject_ID` int DEFAULT NULL,
  `ImageObject_Path` varchar(300) DEFAULT NULL,
...
-- Dump completed on 2022-06-20 10:40:03
